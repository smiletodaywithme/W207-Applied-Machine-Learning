## Logistic Regression and NN at work:
...
# Calculate and plot the decision boundary after training:
...
## We build a n-layer neural network with: 1 input layer, 1 hidden layer, and 1 output layer:
...
# 4. We finally create the function to train our Neural Network:
...
# 5.1.1. Build a model with a 2-dimensional hidden layer:
...
# 5.1.1. Build a model with a 6-dimensional hidden layer:
